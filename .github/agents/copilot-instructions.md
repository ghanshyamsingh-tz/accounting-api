...
- .NET 10 (C# with nullable reference types enabled) + ASP.NET Core 10, EF Core 10, FluentValidation, Polly, Serilog, OpenTelemetry (002-user-login-alerts)
- PostgreSQL 17+ with identity schema, Redis for session/cache, Kafka for events (002-user-login-alerts)
...
## Recent Changes
- 002-user-login-alerts: Added .NET 10 (C# with nullable reference types enabled) + ASP.NET Core 10, EF Core 10, FluentValidation, Polly, Serilog, OpenTelemetry
